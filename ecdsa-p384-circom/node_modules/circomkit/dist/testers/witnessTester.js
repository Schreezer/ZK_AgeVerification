...
class WitnessTester {
    ...
    async expectFail(input) {
        await this.calculateWitness(input).then(() => chai_1.assert.fail('Expected witness calculation to fail.'), err => {
            // console.log(err.message);
            (0, chai_1.expect)(err.message.startsWith('Error: Assert Failed.')).to.be.true;
        });
    }
