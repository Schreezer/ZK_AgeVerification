...
void LessThan_33_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void LessThan_33_run(uint ctx_index,Circom_CalcWit* ctx);
void GreaterEqThan_34_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void GreaterEqThan_34_run(uint ctx_index,Circom_CalcWit* ctx);
void AgeVerificationWithEdDSA_35_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void AgeVerificationWithEdDSA_35_run(uint ctx_index,Circom_CalcWit* ctx);
...
Num2Bits_32_run,
LessThan_33_run,
GreaterEqThan_34_run,
AgeVerificationWithEdDSA_35_run };
...
uint get_main_input_signal_no() {return 802;}

uint get_total_signal_no() {return 52768;}

uint get_number_of_components() {return 4350;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 20527;}

uint get_size_of_constants() {return 69;}
...
// load src
Fr_pow(&expaux[0],&lvar[0],&circuitConstants[68]); // line circom 40
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_add(&expaux[2],&circuitConstants[68],&circuitConstants[2]); // line circom 41
...
{
std::string new_cmp_name = "e2m";
Edwards2Montgomery_9_create(mySignalStart+951,123+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 123+ctx_index+1;
}
{
uint aux_create = 1;
...
{
std::string new_cmp_name = "m2e";
Montgomery2Edwards_14_create(mySignalStart+955,124+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[166] = 124+ctx_index+1;
}
{
PFrElement aux_dest = &lvar[1];
// load src
...
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 143
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 43);
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 43);
// end load src
...
// load src
Fr_sub(&expaux[0],&lvar[1],&circuitConstants[6]); // line circom 154
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 125);
cmp_index_ref_load = ((1 * Fr_toInt(&expaux[0])) + 125);
// end load src
...
Segment_15_create(mySignalStart+800,3+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 3+ctx_index+1;
}
{
std::string new_cmp_name = "segments[1]";
Segment_15_create(mySignalStart+6743,603+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 603+ctx_index+1;
}
{
std::string new_cmp_name = "segments[2]";
Segment_15_create(mySignalStart+12686,1203+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 1203+ctx_index+1;
}
{
std::string new_cmp_name = "segments[3]";
Segment_16_create(mySignalStart+18629,1803+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 1803+ctx_index+1;
}
{
uint aux_create = 4;
int aux_cmp_num = 0+ctx_index+1;
...
{
std::string new_cmp_name = "compConstant";
CompConstant_1_create(mySignalStart+6712,25+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 25+ctx_index+1;
}
{
std::string new_cmp_name = "bits2pointA";
Bits2Point_Strict_8_create(mySignalStart+1038,1+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 1+ctx_index+1;
}
{
std::string new_cmp_name = "bits2pointR8";
Bits2Point_Strict_8_create(mySignalStart+3875,13+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[2] = 13+ctx_index+1;
}
{
std::string new_cmp_name = "hash";
Pedersen_18_create(mySignalStart+7273,33+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[3] = 33+ctx_index+1;
}
{
std::string new_cmp_name = "point2bitsH";
Point2Bits_Strict_19_create(mySignalStart+48835,4334+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[4] = 4334+ctx_index+1;
}
{
std::string new_cmp_name = "dbl1";
BabyDbl_20_create(mySignalStart+7231,27+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[5] = 27+ctx_index+1;
}
{
std::string new_cmp_name = "dbl2";
BabyDbl_20_create(mySignalStart+7245,29+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[6] = 29+ctx_index+1;
}
{
std::string new_cmp_name = "dbl3";
BabyDbl_20_create(mySignalStart+7259,31+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[7] = 31+ctx_index+1;
}
{
std::string new_cmp_name = "isZero";
IsZero_21_create(mySignalStart+30893,2341+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[8] = 2341+ctx_index+1;
}
{
std::string new_cmp_name = "mulAny";
EscalarMulAny_26_create(mySignalStart+30896,2342+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[9] = 2342+ctx_index+1;
}
{
std::string new_cmp_name = "addRight";
BabyAdd_17_create(mySignalStart+1028,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[10] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "mulFix";
EscalarMulFix_30_create(mySignalStart+38863,3373+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[11] = 3373+ctx_index+1;
}
{
PFrElement aux_dest = &lvar[1];
// load src
...
Num2Bits_32_create(mySignalStart+3,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
...
LessThan_33_create(mySignalStart+3,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint cmp_index_ref = 0;
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
LessThan_33_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
...
ctx->componentMemory[coffset].templateName = "AgeVerificationWithEdDSA";
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 802;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
EdDSAVerifier_31_create(mySignalStart+1059,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "ge";
GreaterEqThan_34_create(mySignalStart+52727,4346+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[1] = 4346+ctx_index+1;
}
{
PFrElement aux_dest = &lvar[0];
// load src
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[64]); // line circom 27
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 803)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 771)]);
}
{
PFrElement aux_dest = &lvar[0];
// load src
Fr_add(&expaux[0],&lvar[0],&circuitConstants[2]); // line circom 27
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[64]); // line circom 27
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[56]); // line circom 30
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 803)];
// load src
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[56]); // line circom 36
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 803)]);
}
// no need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter > 0);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 259)]);
}
// no need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter > 0);
...
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * Fr_toInt(&lvar[0])) + 768)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 515)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
GreaterEqThan_34_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
...
AgeVerificationWithEdDSA_35_create(1,0,ctx,"main",0);
AgeVerificationWithEdDSA_35_run(0,ctx);
}
