/**
 * Demo script for the Pedersen-based age verification
 * This script runs the full verification flow with Pedersen commitments
 */

const { runFullVerificationFlow } = require('./pedersen_age_verification_mock');

async function runDemo() {
    console.log('=== ZK Age Verification with Pedersen Commitments Demo ===\n');
