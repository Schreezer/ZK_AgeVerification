/**
 * Setup script for the ZK Age Verification circuit
 *
...
async function setupCircuit() {
    console.log('=== ZK Age Verification Circuit Setup ===\n');

    // Step 1: Generate a Powers of Tau file for testing
    ...
    console.log('The circuit has been compiled and the necessary keys have been generated.');
    console.log('You can now run the demo with: node run_full_demo.js');
}
