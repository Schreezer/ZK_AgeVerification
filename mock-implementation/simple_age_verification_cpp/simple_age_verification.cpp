...
void SimpleAgeVerification_3_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void SimpleAgeVerification_3_run(uint ctx_index,Circom_CalcWit* ctx);
Circom_TemplateFunction _functionTable[4] = { 
Num2Bits_0_run,
LessThan_1_run,
GreaterEqThan_2_run,
SimpleAgeVerification_3_run };
...
ctx->componentMemory[coffset].templateName = "SimpleAgeVerification";
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 2;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
SimpleAgeVerification_3_create(1,0,ctx,"main",0);
SimpleAgeVerification_3_run(0,ctx);
}
